...
func (s *Server) registerManagementRoutes() {
	...
	mgmt.Use(s.managementAvailabilityMiddleware(), s.mgmt.Middleware())
	{
		...
		mgmt.GET("/auth-file-pools", s.mgmt.GetAuthFilePools)
		mgmt.PUT("/auth-file-pools", s.mgmt.PutAuthFilePools)
		mgmt.PATCH("/auth-file-pools", s.mgmt.PatchAuthFilePools)
		mgmt.DELETE("/auth-file-pools", s.mgmt.DeleteAuthFilePools)
